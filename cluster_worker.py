...
from automl.plot import plot_clusters, correlation_matrix_plotly
from automl.handle_null_value import contains_missing_value, remove_high_null, fill_null_values
from automl.preprocess import convert_to_numeric, remove_duplicates, transform_data_for_clustering
from automl.llm_service import decide_fill_null, decide_encode_type, decide_cluster_model
from automl.pca import decide_pca, perform_PCA_for_clustering
from automl.util_automl import save_model, calculate_silhouette_score, calculate_calinski_harabasz_score, calculate_davies_bouldin_score, gmm_predict, estimate_optimal_clusters
from automl.cluster_model import train_select_cluster_model
from automl.util_general import contain_null_attributes_info, separate_fill_null_list, check_all_columns_numeric, non_numeric_columns_and_head, separate_decode_list, get_cluster_method_name
        ...
        with st.container():
            ...
            if not st.session_state["decided_model"]:
                with st.spinner("Deciding models based on data..."):
                    ...
                    model_dict = decide_cluster_model(shape_info, description_info, cluster_info)
